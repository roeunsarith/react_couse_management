...
const CategoryPage =()=>{
    ...
    const getList = () => {
        ...
        if(search!=='' || search!==null){
            params.txt_search = search
        }
        fetchData("api/category","GET",params).then(res=>{
            setLoading(false)
            setList(res.list)
            // alert(res.msg)
        })
        ...
        <>
            ...
            <div className='tbData'>
                <Table
                    ...
                    <Table.Body>
                        {list && filteredList(list, search).map((item,index)=>{
                            return(
                    ...
                    <Table.Pagination
                        ...
                        noMargin
                        align="center"
                        total={Math.ceil(filteredList(list, search).length/count)}
                        rowsPerPage={count}
